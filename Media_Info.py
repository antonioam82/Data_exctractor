...
class Visor:
    def __init__(self):
        ...
        Entry(self.ventana,textvariable=self.codecLong,width=48,bg=color_fondo,fg=color_car).place(x=166,y=63)
        Label(self.ventana,text="avg frame rate:",bg=color_ventana,font=("Arial",13)).place(x=43,y=103)
        Entry(self.ventana,textvariable=self.rateValue,bg=color_fondo,fg=color_car).place(x=166,y=106)
        Label(self.ventana,text="bit rate:",bg=color_ventana,font=("Arial",13)).place(x=97,y=133)
        Entry(self.ventana,textvariable=self.rateBit,bg=color_fondo,fg=color_car).place(x=166,y=135)
        Label(self.ventana,text="chroma location:",bg=color_ventana,font=("Arial",13)).place(x=30,y=163)
        Entry(self.ventana,textvariable=self.chromaValue,bg=color_fondo,fg=color_car).place(x=166,y=165)
        Label(self.ventana,text="codec name:",bg=color_ventana,font=("Arial",13)).place(x=55,y=193)
        Entry(self.ventana,textvariable=self.codecValue,bg=color_fondo,fg=color_car).place(x=166,y=195)
        Label(self.ventana,text="codec tag:",bg=color_ventana,font=("Arial",13)).place(x=73,y=223)
        Entry(self.ventana,textvariable=self.codecTag,bg=color_fondo,fg=color_car).place(x=166,y=225)
        Label(self.ventana,text="codec tag string:",bg=color_ventana,font=("Arial",13)).place(x=28,y=253)
        Entry(self.ventana,textvariable=self.codecTstr,bg=color_fondo,fg=color_car).place(x=166,y=255)
        Label(self.ventana,text="codec time base:",bg=color_ventana,font=("Arial",13)).place(x=25,y=283)
        Entry(self.ventana,textvariable=self.codecTbase,bg=color_fondo,fg=color_car).place(x=166,y=285)
        Label(self.ventana,text="codec type:",bg=color_ventana,font=("Arial",13)).place(x=64,y=313)
        Entry(self.ventana,textvariable=self.codecType,bg=color_fondo,fg=color_car).place(x=166,y=315)
        Label(self.ventana,text="coded height:",bg=color_ventana,font=("Arial",13)).place(x=52,y=343)
        Entry(self.ventana,textvariable=self.codedHeight,bg=color_fondo,fg=color_car).place(x=166,y=345)
        Label(self.ventana,text="display aspect ratio:",bg=color_ventana,font=("Arial",13)).place(x=5,y=373)
        Entry(self.ventana,textvariable=self.disaspRatio,bg=color_fondo,fg=color_car).place(x=166,y=375)
        Label(self.ventana,text="divx packed:",bg=color_ventana,font=("Arial",13)).place(x=62,y=403)#88
        Entry(self.ventana,textvariable=self.divxPacked,bg=color_fondo,fg=color_car).place(x=166,y=405)
        Label(self.ventana,text="duration:",bg=color_ventana,font=("Arial",13)).place(x=88,y=433)
        Entry(self.ventana,textvariable=self.duration,bg=color_fondo,fg=color_car).place(x=166,y=435)
        Label(self.ventana,text="duration ts:",bg=color_ventana,font=("Arial",13)).place(x=70,y=463)
        Entry(self.ventana,textvariable=self.durationTs,bg=color_fondo,fg=color_car).place(x=166,y=465)
        Label(self.ventana,text="profile:",bg=color_ventana,font=("Arial",13)).place(x=65,y=493)
        Entry(self.ventana,textvariable=self.profile,width=27,bg=color_fondo,fg=color_car).place(x=125,y=495)
        Label(self.ventana,text="has b frames:",bg=color_ventana,font=("Arial",13)).place(x=360,y=103)
        Entry(self.ventana,textvariable=self.hasbFrames,bg=color_fondo,fg=color_car).place(x=473,y=106)
        Label(self.ventana,text="height:",bg=color_ventana,font=("Arial",13)).place(x=412,y=133)
        Entry(self.ventana,textvariable=self.height,bg=color_fondo,fg=color_car).place(x=473,y=136)
        Label(self.ventana,text="index:",bg=color_ventana,font=("Arial",13)).place(x=418,y=163)
        Entry(self.ventana,textvariable=self.index,bg=color_fondo,fg=color_car).place(x=473,y=166)
        Label(self.ventana,text="is avc:",bg=color_ventana,font=("Arial",13)).place(x=414,y=193)
        Entry(self.ventana,textvariable=self.isAvc,bg=color_fondo,fg=color_car).place(x=473,y=196)
        Label(self.ventana,text="level:",bg=color_ventana,font=("Arial",13)).place(x=425,y=223)
        Entry(self.ventana,textvariable=self.level,bg=color_fondo,fg=color_car).place(x=473,y=226)
        Label(self.ventana,text="nal length size:",bg=color_ventana,font=("Arial",13)).place(x=353,y=253)
        Entry(self.ventana,textvariable=self.nalLensiz,bg=color_fondo,fg=color_car).place(x=473,y=256)
        Label(self.ventana,text="nb frames:",bg=color_ventana,font=("Arial",13)).place(x=383,y=283)
        Entry(self.ventana,textvariable=self.nbFrames,bg=color_fondo,fg=color_car).place(x=473,y=286)
        Label(self.ventana,text="pix fmt:",bg=color_ventana,font=("Arial",13)).place(x=409,y=313)
        Entry(self.ventana,textvariable=self.pixFmt,bg=color_fondo,fg=color_car).place(x=473,y=316)
        Label(self.ventana,text="r frame rate:",bg=color_ventana,font=("Arial",13)).place(x=370,y=343)
        Entry(self.ventana,textvariable=self.rframeRate,bg=color_fondo,fg=color_car).place(x=473,y=346)
        Label(self.ventana,text="refs:",bg=color_ventana,font=("Arial",13)).place(x=428,y=373)
        Entry(self.ventana,textvariable=self.refs,bg=color_fondo,fg=color_car).place(x=473,y=376)
        Label(self.ventana,text="start pts:",bg=color_ventana,font=("Arial",13)).place(x=399,y=403)
        Entry(self.ventana,textvariable=self.startPts,bg=color_fondo,fg=color_car).place(x=473,y=406)
        Label(self.ventana,text="start time:",bg=color_ventana,font=("Arial",13)).place(x=390,y=433)
        Entry(self.ventana,textvariable=self.startTime,bg=color_fondo,fg=color_car).place(x=473,y=436)
        Label(self.ventana,text="time base:",bg=color_ventana,font=("Arial",13)).place(x=387,y=463)
        Entry(self.ventana,textvariable=self.timeBase,bg=color_fondo,fg=color_car).place(x=473,y=466)
        Label(self.ventana,text="width:",bg=color_ventana,font=("Arial",13)).place(x=420,y=493)
        Entry(self.ventana,textvariable=self.width,bg=color_fondo,fg=color_car).place(x=473,y=496)
